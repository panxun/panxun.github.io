parcelRequire = function(e, r, t, n) {
	...
	"XR92": [function(require, module, exports) {
		...
		! function(e, n) {
			...
			var e, n = function() {
				...
				function J(t) {
					try {
						return t ? "true" == t || "false" != t && ("null" == t ? null : +t + "" == t ? +t : /^[\[\{]/.test(t) ? r.parseJSON(
							t) : t) : t
					} catch (e) {
						return t
					}
				...
				return O.matches = function(t, e) {
						...
						var o, a, s;
						return v.test(t) && (o = r(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(g, "<$1></$2>")),
							n === e && (n = m.test(t) && RegExp.$1), n in T || (n = "*"), (s = T[n]).innerHTML = "" + t, o = r.each(l
								.call(s.childNodes),
								function() {
									s.removeChild(this)
						...
						return "boolean" == typeof t && (r = t, t = i.shift()), i.forEach(function(i) {
							! function t(r, i, o) {
								for (n in i) o && (R(i[n]) || D(i[n])) ? (R(i[n]) && !R(r[n]) && (r[n] = {}), D(i[n]) && !D(r[n]) && (r[
									n] = []), t(r[n], i[n], o)) : i[n] !== e && (r[n] = i[n])
							}(t, i, r)
						}), t
					}, O.qsa = function(t, e) {
						var n, r = "#" == e[0],
						...
						return t.getElementById && a && r ? (n = t.getElementById(o)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType &&
							11 !== t.nodeType ? [] : l.call(a && !r && t.getElementsByClassName ? i ? t.getElementsByClassName(o) : t.getElementsByTagName(
						...
						for (; e && (e = e.parentNode);)
							if (e === t) return !0;
						return !1
					}, r.type = L, r.isFunction = $, r.isWindow = F, r.isArray = D, r.isPlainObject = R, r.isEmptyObject =
					function(t) {
						var e;
						for (e in t) return !1;
						return !0
						...
						show: function() {
							return this.each(function() {
								...
								"none" == this.style.display && (this.style.display = ""), "none" == getComputedStyle(this, "").getPropertyValue(
									"display") && (this.style.display = (t = this.nodeName, h[t] || (e = f.createElement(t), f.body.appendChild(
										e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" ==
									n && (n = "block"), h[t] = n), h[t]))
							})
						},
						...
						position: function() {
							if (this.length) {
								...
								return n.top -= parseFloat(r(t).css("margin-top")) || 0, n.left -= parseFloat(r(t).css("margin-left")) ||
									0, i.top += parseFloat(r(e[0]).css("border-top-width")) || 0, i.left += parseFloat(r(e[0]).css(
										"border-left-width")) || 0, {
										top: n.top - i.top,
										left: n.left - i.left
									}
						...
						r.fn[t] = function(i) {
							var o, a = this[0];
							return i === e ? F(a) ? a["inner" + n] : k(a) ? a.documentElement["scroll" + n] : (o = this.offset()) &&
						...
						r.fn[n] = function() {
							var n, a, s = r.map(arguments, function(t) {
									...
									return "array" == (n = L(t)) ? (t.forEach(function(t) {
										return t.nodeType !== e ? i.push(t) : r.zepto.isZ(t) ? i = i.concat(t.get()) : void(i = i.concat(
											O.fragment(t)))
			...
			return t.Zepto = n, void 0 === t.$ && (t.$ = n),
				function(e) {
					...
					function p(t, e, n, r) {
						...
						return (s[h(t)] || []).filter(function(t) {
							return t && (!e.e || t.e == e.e) && (!e.ns || i.test(t.ns)) && (!n || h(t.fn) === h(n)) && (!r || t.sel ==
								r)
						})
					}
					...
					function T(t, r) {
						...
						}), t.timeStamp || (t.timeStamp = Date.now()), (r.defaultPrevented !== n ? r.defaultPrevented :
							"returnValue" in r ? !1 === r.returnValue : r.getPreventDefault && r.getPreventDefault()) && (t.isDefaultPrevented =
							x)), t
					}
					...
					e.fn.delegate = function(t, e, n) {
							...
							return t && !a(t) ? (e.each(t, function(t, e) {
								h.on(t, r, s, e, c)
							}), h) : (a(r) || o(u) || !1 === u || (u = s, s = r, r = n), u !== n && !1 !== s || (u = s, s = n), !1 ===
								u && (u = b), h.each(function(n, o) {
									c && (l = function(t) {
							...
							return (t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))._args = n, this.each(function() {
								t.type in l && "function" == typeof this[t.type] ? this[t.type]() : "dispatchEvent" in this ? this.dispatchEvent(
				...
				function(e) {
					...
					function m(t, e, n, r) {
						var i = n.context;
						n.success.call(i, t, "success", e), r && r.resolveWith(i, [t, "success", e]), p(n, i, "ajaxSuccess", [e, n,
							t
						]), g("success", e, n)
					}
					...
					h.href = t.location.href, e.active = 0, e.ajaxJSONP = function(n, r) {
						...
						return r && r.promise(p), e(l).on("load error", function(i, o) {
							clearTimeout(s), e(l).off().remove(), "error" != i.type && a ? m(a[0], p, n, r) : v(null, o || "error",
								p, n, r), t[c] = f, a && e.isFunction(f) && f(a[0]), f = a = void 0
						}), !1 === d(p, n) ? (h("abort"), p) : (t[c] = function() {
							a = arguments
						}, l.src = n.url.replace(/\?(.+)=\?/, "?$1=" + c), o.head.appendChild(l), n.timeout > 0 && (s =
							setTimeout(function() {
								h("timeout")
							}, n.timeout)), p)
					}, e.ajaxSettings = {
						...
						}(b), b.crossDomain || ((a = o.createElement("a")).href = b.url, a.href = a.href, b.crossDomain = h.protocol +
								"//" + h.host != a.protocol + "//" + a.host), b.url || (b.url = t.location.toString()), (g = b.url.indexOf(
								"#")) > -1 && (b.url = b.url.slice(0, g)),
							function(t) {
								t.processData && t.data && "string" != e.type(t.data) && (t.data = e.param(t.data, t.traditional)), !t.data ||
									t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = x(t.url, t.data), t.data =
										void 0)
							}(b);
						var j = b.dataType,
							T = /\?.+=\?/.test(b.url);
						if (T && (j = "jsonp"), !1 !== b.cache && (i && !0 === i.cache || "script" != j && "jsonp" != j) || (b.url =
								x(b.url, "_=" + Date.now())), "jsonp" == j) return T || (b.url = x(b.url, b.jsonp ? b.jsonp + "=?" : !1 ===
							b.jsonp ? "" : "callback=?")), e.ajaxJSONP(b, E);
						var w, S = b.accepts[j],
							C = {},
							N = function(t, e) {
								C[t.toLowerCase()] = [t, e]
						...
						if (E && E.promise(P), b.crossDomain || N("X-Requested-With", "XMLHttpRequest"), N("Accept", S || "*/*"), (
								S = b.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]), P.overrideMimeType && P.overrideMimeType(
								S)), (b.contentType || !1 !== b.contentType && b.data && "GET" != b.type.toUpperCase()) && N(
								"Content-Type", b.contentType || "application/x-www-form-urlencoded"), b.headers)
						...
						if (P.setRequestHeader = N, P.onreadystatechange = function() {
								if (4 == P.readyState) {
									...
									if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == O) {
										if (j = j || ((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r &&
												(r == l ? "html" : r == c ? "json" : s.test(r) ? "script" : u.test(r) && "xml") || "text"),
											"arraybuffer" == P.responseType || "blob" == P.responseType) t = P.response;
										else {
											t = P.responseText;
											try {
												t = function(t, e, n) {
												...
												}(t, j, b), "script" == j ? (0, eval)(t) : "xml" == j ? t = P.responseXML : "json" == j && (t = f.test(
						...
						return r.add = function(t, n) {
							...
							function t(n, r, i, o) {
								...
								e.each(r, function(r, c) {
									a = e.type(c), o && (r = i ? o : o + "[" + (u || "object" == a || "array" == a ? r : "") + "]"), !o &&
										s ? n.add(c.name, c.value) : "array" == a || !i && "object" == a ? t(n, c, i, r) : n.add(r, c)
								})
					...
					return this[0] && e.each(this[0].elements, function(r, o) {
						n = o.type, (t = o.name) && "fieldset" != o.nodeName.toLowerCase() && !o.disabled && "submit" != n &&
							"reset" != n && "button" != n && "file" != n && ("radio" != n && "checkbox" != n || o.checked) && i(e(o).val())
					}), r
	...
	"Bb20": [function(require, module, exports) {
		...
		delete Object.prototype.document, delete Object.prototype.location, window.requestAnimFrame = window.requestAnimationFrame ||
			...
			.msRequestAnimationFrame || function(t) {
				...
				function w() {
					u(), ++c > 150 && c % 8 == 0 && (a.fillStyle = "rgba(0,0,0,.04)", a.fillRect(-3 * n, -3 * n, 6 * n, 6 * n)),
						f(.025)
				}
				...
				for (var m, s, g, b, v = 2e4; v--;) m = void 0, s = void 0, g = void 0, b = void 0, d.push({
					...
					size: 1.2,
					color: (m = h(120, 255), s = h(120, 255), g = h(120, 255), b = h(30, 100) / 100, "rgba(" + m + "," + s +
						"," + g + "," + b + ")")
				});
				! function() {
				...
				a.translate(p, 0),
					function t() {
						...
						i.width = t = i.offsetWidth, i.height = e = i.offsetHeight, a.fillStyle = "rgba(21,21,21,1)", a.fillRect(0,
							0, t, e)
					}
			}), window.onscroll = function() {
				t(window).scrollTop() > .6 * t(window).height() ? t(".background").addClass("fixed") : t(".background").removeClass(
					"fixed")
			}, t(function() {
				e(), console.log("debug")
			});
