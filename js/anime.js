...
var anime=function(){
  var t={
    ...
    easeInElastic:function(t,n,e,r,a){
      ...
      else var u=i/(2*Math.PI)*Math.asin(e/o);return-(o*Math.pow(2,10*(t-=1))*Math.sin((t*r-u)*(2*Math.PI)/i))+n
  	},
  	easeOutElastic:function(t,n,e,r,a){
  		var u=1.70158,i=r*(1-Math.min(a,999)/1e3),o=e;
  		if(0==t)return n;if(1==(t/=r))return n+e;
  		if(o<Math.abs(e)){
  			o=e;var u=i/4
  		}
  		else var u=i/(2*Math.PI)*Math.asin(e/o);return o*Math.pow(2,-10*t)*Math.sin((t*r-u)*(2*Math.PI)/i)+e+n
  	},
  	easeInOutElastic:function(t,n,e,r,a){
  		var u=1.70158,i=r*(1-Math.min(a,99)/100),o=e;
  		if(0==t)return n;if(2==(t/=r/2))return n+e;
  		if(o<Math.abs(e)){
  			o=e;var u=i/4
  		}
  		else var u=i/(2*Math.PI)*Math.asin(e/o);return 1>t?-.5*(o*Math.pow(2,10*(t-=1))*Math.sin((t*r-u)*(2*Math.PI)/i))+n:o*Math.pow(2,-10*(t-=1))*Math.sin((t*r-u)*(2*Math.PI)/i)*.5+e+n
  	},
  ...
  n={
  	duration:1e3,delay:0,loop:!1,autoPlay:!0,direction:"normal",easing:"easeInOutQuad",elasticity:50,speed:1,round:!1,begin:void 0,update:void 0,complete:void 0
  },
  ...
  s=function(t){
    ...
    O=function(t,n){
      switch(M(t,n)){
        case"transform":return I(t,n);
        case"css":return y(t,n);
        case"attribute":return t.getAttribute(n)
      }
      return t[n]||0
    },
    w=function(t,n,e){
    ...
    A=function(t){
      var n=/-?\d*\.?\d+/g;
      return{
        numbers:u(t).match(n)?u(t).match(n).map(Number):[0],strings:u(t).split(n)
      }
    },
    k=function(t){
    ...
    Q=function(t,n,e,a){
      ...
      return{
        from:u.length>1?u[0]:O(t,n),to:u.length>1?u[1]:u[0]
      }
    },
    D=function(t,n,e,r){
      var a={ };
      if("transform"===e)a.from=t+"("+b(t,n.from,n.to)+")",a.to=t+"("+b(t,n.to)+")";
        ...
        var u="css"===e?y(r,t):void 0;a.from=w(n,n.from,u),a.to=w(n,n.to,u)
      }
      return{
        from:A(a.from),to:A(a.to)
      }
    },
    j=function(t,n){
      var e=[];
      return t.forEach(function(a,u){
        var i=a.target;n.forEach(function(n){
          var o=M(i,n.name);
          if(o){
    ...
    q=function(t,n){
      var e=j(t,n),r=l(e,["name","from","to","delay","duration"]);
    ...
    C=function(n,e){
      ...
      return n.currentValues={
        progress:a,full:x(a,n.to.strings,n.from.strings)
      },
      ...
      if(t.currentTime=Math.min(n,t.totalDuration),t.progress=t.currentTime/t.totalDuration*100,t.interpolations.forEach(function(r){
        ...
        t.values[r.name]={ },r.animatables.forEach(function(n){
          ...
          switch(t.values[r.name][u]=r.currentValues,r.type){
            case"css":n.target.style[r.name]=a;
              break;
            case"attribute":n.target.setAttribute(r.name,a);
              break;
            case"object":n.target[r.name]=a;
              break;
            case"transform":e||(e={ }),e[u]||(e[u]=[]),f(e[u],a)||e[u].push(a)
          }
        })
      }),e)
